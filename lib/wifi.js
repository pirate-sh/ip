...
function ifdownup(message) {
  exec('systemctl disable hostapd', (x, y, z) => {
    exec('systemctl disable dnsmasq', (x, y, z) => {
      exec('service dhcpcd restart', (x, y, z) => {
        exec('service hostapd stop', (x, y, z) => {
          exec('service dnsmasq stop', (x, y, z) => {
            exec('ifup wlan0', (x, y, z) => {
              exec('ifdown wlan0', (x, y, z) => {
                exec('sleep 1', (x, y, z) => {
                  exec('ifup wlan0', (x, y, z) => {
                    console.log(message);
                  });
